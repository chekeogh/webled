...
const int NUM_OF_LEDS_ON_STRIP = 10;

// !!! Specify the MAC address and IP address for your controller         <====<
// The IP address will be dependent on your local network
byte mac[] = { 0xDE, 0xAE, 0xE6, 0x78, 0xBB, 0X01 };
IPAddress ip(192, 168, 0, 21);  // You may leave this as is
const int PORT = 81;  // You may leave this as is
...
void respond(int statusCode, const char* statusMsg, boolean keepAlive, String data)
{
        ...
        if (data) { client.println("Access-Control-Allow-Origin: *");
                    client.print(data); }
        delay(1);
        client.stop();
}
